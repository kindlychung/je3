 ...
 */
public abstract class AbstractTokenizer implements je3.classes.Tokenizer {
    boolean skipSpaces;
    boolean tokenizeSpaces;
    boolean tokenizeNumbers;
    boolean tokenizeWords;
    boolean testquotes;
    je3.classes.Tokenizer.WordRecognizer wordRecognizer;
    Map keywordMap;
    ...
    public je3.classes.Tokenizer skipSpaces(boolean skip) {
	skipSpaces = skip;
	return this;
    }

    public je3.classes.Tokenizer tokenizeSpaces(boolean tokenize) {
	tokenizeSpaces = tokenize;
	return this;
    }

    public je3.classes.Tokenizer tokenizeNumbers(boolean tokenize) {
	tokenizeNumbers = tokenize;
	return this;
    }
    
    public je3.classes.Tokenizer tokenizeWords(boolean tokenize) {
	tokenizeWords = tokenize;
	return this;
    }

    public je3.classes.Tokenizer wordRecognizer(je3.classes.Tokenizer.WordRecognizer wordRecognizer) {
	this.wordRecognizer = wordRecognizer;
	return this;
    }

    public je3.classes.Tokenizer quotes(String openquotes, String closequotes) {
    ...
    public je3.classes.Tokenizer trackPosition(boolean track) {
	if (text != null) throw new IllegalStateException();
	trackPosition = track;
	return this;
    }

    public je3.classes.Tokenizer keywords(String[] keywords) {
	if (keywords != null) {
    ...
    public je3.classes.Tokenizer maximumTokenLength(int size) {
